...
(function () {
  ...
  function convertStringToArrayAndRemoveDuplicates(str, addonStr) {
    ...
    const fullStr = `${str.replace(moreBlankRegex, " ").replace(noneNecessarySymbol, ",")},${addonStr}`
  ...
  function formtNewsInformation(parentSelector) {
    ...
    // const handledDom = addImageAlternativeDescription(htmlToNode(editor_iframe.innerHTML));
    // editor_iframe.innerHTML = handledDom.innerHTML
    // console.log(handledDom.innerHTML);
